...
TEST_CASE("Testing the class Boid") {
  ...
  SUBCASE("Setting parameters throws") {
    bd::Boid boid1;

    CHECK_THROWS(boid1.setPar_s(2));
    CHECK_THROWS(boid1.setPar_a(2));
    CHECK_THROWS(boid1.setPar_c(2));

    CHECK_THROWS(boid1.setPar_s(-1));
    CHECK_THROWS(boid1.setPar_a(-1));
    CHECK_THROWS(boid1.setPar_c(-1));

    boid1.setPar_d(5);

    CHECK_THROWS(boid1.setPar_ds(6));

    CHECK_THROWS(boid1.setPar_d(-1));
    CHECK_THROWS(boid1.setPar_ds(-2));

    bd::Parameters invalidParam_d = {-1.0, 0.5, 0.3, 0.2, 0.1};
    bd::Parameters invalidParam_ds = {1.0, -0.5, 0.3, 0.2, 0.1};
    bd::Parameters invalidParam_ds2 = {1.0, 2.0, 0.3, 0.2, 0.1};
    bd::Parameters invalidParam_s = {1.0, 0.5, 2, 0.2, 0.1};
    bd::Parameters invalidParam_s2 = {1.0, 0.5, -2, 0.2, 0.1};
    bd::Parameters invalidParam_a = {1.0, 0.5, 0.3, 2, 0.1};
    bd::Parameters invalidParam_a2 = {1.0, 0.5, 0.3, -2, 0.1};
    bd::Parameters invalidParam_c = {1.0, 0.5, 0.3, 0.2, 2};
    bd::Parameters invalidParam_c2 = {1.0, 0.5, 0.3, 0.2, -2};

    CHECK_THROWS(boid1.setPar(invalidParam_d));
    CHECK_THROWS(boid1.setPar(invalidParam_ds));
    CHECK_THROWS(boid1.setPar(invalidParam_ds2));
    CHECK_THROWS(boid1.setPar(invalidParam_s));
    CHECK_THROWS(boid1.setPar(invalidParam_s2));
    CHECK_THROWS(boid1.setPar(invalidParam_a));
    CHECK_THROWS(boid1.setPar(invalidParam_a2));
    CHECK_THROWS(boid1.setPar(invalidParam_c));
    CHECK_THROWS(boid1.setPar(invalidParam_c2));
  }
